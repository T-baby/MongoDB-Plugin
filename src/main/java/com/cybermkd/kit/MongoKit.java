...
public enum MongoKit {
    ...
    protected MongoDatabase defaultDb;
    protected Validator validator;

    public void init(MongoClient client, String database) {
        MongoKit.INSTANCE.client = client;
        MongoKit.INSTANCE.defaultDb = client.getDatabase(database);
    }
    ...
    public List<JSONObject> find(String collectionName, Bson query, Bson projection, Bson sort, int limit, int skip, String join) {
    ...
    public <T> List<T> find(String collectionName, Bson query, Bson projection, Bson sort, int limit, int skip, String join, Class<T> clazz) {
